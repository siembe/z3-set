...
export const TrackerStateProvider = ({children}) => {
  ...
  const itemOptions = {
    "bow": {icon: "./items/bow.png"},
    "blueBoomerang": {icon: "./items/blue_boomerang.png"},
    "redBoomerang": {icon: "./items/red_boomerang.png"},
    "hookshot": {icon: "./items/hookshot.png"},
    "mushroom": {icon: "./items/mushroom.png"},
    "magicPowder": {icon: "./items/magic_powder.png"},
    "fireRod": {icon: "./items/fire_rod.png"},
    "iceRod": {icon: "./items/ice_rod.png"},
    "bombos": {icon: "./items/bombos_medallion.png"},
    "ether": {icon: "./items/ether_medallion.png"},
    "quake": {icon: "./items/quake_medallion.png"},
    "lamp": {icon: "./items/lamp.png"},
    "hammer": {icon: "./items/magic_hammer.png"},
    "shovel": {icon: "./items/shovel.png"},
    "flute": {icon: "./items/flute.png"},
    "bugNet": {icon: "./items/bug_net.png"},
    "bookOfMudora": {icon: "./items/book_of_mudora.png"},
    "bottle": {icon: "./items/potion.png"},
    "somaria": {icon: "./items/cane_of_somaria.png"},
    "byrna": {icon: "./items/cane_of_byrna.png"},
    "magicCape": {icon: "./items/magic_cape.png"},
    "magicMirror": {icon: "./items/magic_mirror.png"},
    "fighterSword": {icon: "./items/fighter_sword.png"},
    "masterSword": {icon: "./items/master_sword.png"},
    "temperedSword": {icon: "./items/tempered_sword.png"},
    "butterSword": {icon: "./items/butter_sword.png"},
    "fighterShield": {icon: "./items/fighter_shield.png"},
    "fireShield": {icon: "./items/fire_shield.png"},
    "mirrorShield": {icon: "./items/mirror_shield.png"},
    "blueMail": {icon: "./items/blue_mail.png"},
    "redMail": {icon: "./items/red_mail.png"},
    "pegasusBoots": {icon: "./items/pegasus_boots.png"},
    "powerGloves": {icon: "./items/power_gloves.png"},
    "titanMitts": {icon: "./items/titan_mitts.png"},
    "flippers": {icon: "./items/zoras_flippers.png"},
    "moonPearl": {icon: "./items/moon_pearl2.png"},
    "bigKey": {icon: "./items/big_key.png"},
    "smallKey": {icon: "./items/small_key.png"},
  }
